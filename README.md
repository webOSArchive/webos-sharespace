...
Uses [Sharing Service](https://github.com/webosarchive/sharing-service) which you can self-host. See the [instructions here](https://github.com/webosarchive/sharing-service/blob/main/README.md) to get started!
